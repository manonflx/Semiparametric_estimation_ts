...
```{r wasserstein_farima, out.width='60%', fig.cap="Wasserstein loss functions of two FARIMA(0,d,0) processes where H = 0.8 (d = 1.2). The sample size is 3001. The left column display the entire loss functions for all possible parameter values that a long-memory process can take (0.51 < H < 0.99). The right column is a zoom on the functions."}
set.seed(8963)
...
for (i in 1:length(per_ord_std[,i])){
  WD_1[i] = (mean(abs(sort(t) - sort(per_ord_std[,i]))^p)^(1/p))
  WH_1[i] = sum(per_ord_std[,i])
}

### Plot the Wasserstein loss function 
p1 = ggplot(data = NULL, aes(x = par, y = WD_1)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 10, face = "italic", hjust = 0.5),legend.position = 'bottom', legend.title = element_blank()) +
  ...
  geom_vline(aes(xintercept = par[which.min(WD_1)], colour = paste("MWE: ", round(par[which.min(WD_1)], digits = 3))), show.legend = T) +
  geom_vline(aes(xintercept = par[which.min(WH_1)], colour = paste("Whittle: ", round(par[which.min(WH_1)], digits = 3))), show.legend = T) +
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
  
### Zoom 

p2 = ggplot(data = NULL, aes(x = par, y = WD_1)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 10, face = "italic", hjust = 0.5), legend.position = 'bottom', legend.title = element_blank(), axis.text.y = element_blank()) +
  labs(y = expression(""), x = expression(""),
  ...
  geom_vline(aes(xintercept = par[which.min(WH_1)], colour = paste("Whittle: ", round(par[which.min(WH_1)], digits = 3))), show.legend = T) +
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6")) +
   coord_cartesian(xlim=c(0.775, 0.825), ylim=c((min(WD_1)-0.0001), (min(WD_1)+0.001)))
...
p3 = ggplot(data = NULL, aes(x = par, y = WD_2)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 10, face = "italic", hjust = 0.5), legend.title = element_blank()) +
  labs(y = expression(""), x = expression(""),
       title = paste("Wasserstein Loss, FARIMA(0,d,0)")) +
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
  geom_vline(aes(xintercept = par[which.min(WD_2)], colour = paste("MWE: ", round(par[which.min(WD_2)], digits = 3))), show.legend = T) +
  geom_vline(aes(xintercept = par[which.min(WH_2)], colour = paste("Whittle: ", round(par[which.min(WH_2)], digits = 3))), show.legend = T) +
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
a = ggarrange(p1, p2, nrow = 1, ncol = 2, common.legend = TRUE, legend = 'right')
b = ggarrange(p3, p4, nrow = 1, ncol = 2, common.legend = TRUE, legend = 'right')
...
### Plot the Wasserstein loss function 
ggplot(data = NULL, aes(x = par, y = WD_2)) + geom_line(alpha = 0.6) + theme_classic() +
...
```{r MWE_n, fig.cap="We simulate 200 vectors following an exponential distribution and then compute the MWE of a FARIMA(0,d,0) process with n = 3001. The blue line is the true parameter H = 0.7 value and the red dashed line is the mean of the MWE.", fig.pos="h", out.width='60%'}
set.seed(9393)
sim = 200
...
ggplot(data = NULL, aes(x = MWE_3001)) + 
  ...
  ylab("Count") +
  ggtitle(paste("n = ", n)) +
   geom_vline(aes(xintercept = H, colour = paste("H: ", H)), show.legend = T) +
 geom_vline(aes(xintercept = mean(MWE_3001), colour = paste("Mean: ", round(mean(MWE_3001), digits = 3))), show.legend = T, linetype = "dashed") +
  coord_cartesian(xlim = c(0.51, 0.99)) +
  theme(legend.position = 'bottom', legend.title = element_blank()) +
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6")) +
  ggtitle("")+
   theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5), legend.text = element_text(size = 12))
...
p1 = ggplot(data = NULL, aes(x = par, y = WD)) + geom_line(alpha = 0.6) + theme_classic() +
  ...
  geom_vline(aes(xintercept = par[which.min(WD)], colour = paste("MSWE: ", round(par[which.min(WD)], digits = 3))), show.legend = T) +
   geom_vline(aes(xintercept = par[which.min(WH)], colour = paste("Whittle: ", round(par[which.min(WH)], digits = 3))), show.legend = T, linetype = "dashed") + theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5),legend.position = 'bottom', legend.title = element_blank()) + scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
p2 = ggplot(data = NULL, aes(x = par, y = WD)) + geom_line(alpha = 0.6) + theme_classic() + 
  labs(y = expression(""), x = expression(""),
       title = paste("Zoom on the minimum")) +
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
  geom_vline(aes(xintercept = par[which.min(WD)], colour = paste("MSWE: ", round(par[which.min(WD)], digits = 3))), show.legend = T) + geom_vline(aes(xintercept = par[which.min(WH)], colour = paste("Whittle: ", round(par[which.min(WH)], digits = 3))), show.legend = T) + coord_cartesian(xlim=c(0.79, 0.84), ylim=c((min(WD)-0.0001), (min(WD)+0.001))) + theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5),legend.position = 'bottom', legend.title = element_blank(), axis.text.y = element_blank()) + scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
p3 = ggplot(data = NULL, aes(x = par, y = WD_2)) + geom_line(alpha = 0.6) + theme_classic() +
  ...
  geom_vline(aes(xintercept = par[which.min(WH_2)], colour = paste("Whittle: ", round(par[which.min(WH_2)], digits = 3))), show.legend = T) + theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5),legend.position = 'bottom', legend.title = element_blank()) + scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
p4 = ggplot(data = NULL, aes(x = par, y = WD_2)) + geom_line(alpha = 0.6) + theme_classic() +
  ...
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
  geom_vline(aes(xintercept = par[which.min(WD_2)], colour = paste("MSWE: ", round(par[which.min(WD_2)], digits = 3))), show.legend = T) +
  geom_vline(aes(xintercept = par[which.min(WH_2)], colour = paste("Whittle: ", round(par[which.min(WH_2)], digits = 3))), show.legend = T) + coord_cartesian(xlim=c(0.65, 0.95), ylim=c((min(WD_2)-0.0001), (min(WD_2)+0.01))) +  theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5),legend.position = 'bottom', legend.title = element_blank(), axis.text.y = element_blank()) + scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
```{r qqplot, echo = FALSE, fig.cap="Qqplot of the Wasserstein's SPOs and the Whittle's SPOs. The SPOs are from a long-memory process with H = 0.8 and the sample size is equal to 3001.", out.width='60%'}
set.seed(3459)
### Simulate time series
n = 3001
p = 1
...
minimum_WD =  par[which.min(WD)]
minimum_WD_W = par[which.min(WD_W)]
minimum_WH =  par[which.min(WH)]

## Plot the density 
position_min_WD = match(minimum_WD, par) 
position_min_WD_W = match(minimum_WD_W, par)
position_min_WH = match(minimum_WH, par) 

wdata = data.frame(
  group = factor(rep(c("SPOs of Whittle", "SPOs of Wasserstein"), each=1500)),
  value = c(per_ord_std[, position_min_WH], per_ord_std[, position_min_WD])
)

ggplot(data = wdata, aes(sample = value, colour = factor(group))) + stat_qq(distribution = stats::qexp) + stat_qq_line(distribution = stats::qexp) +
  theme_classic() + scale_colour_manual(values = c("#03045E", "#0077B6")) + theme(legend.title = element_blank(), legend.position = 'bottom')
```

### Figure 7

```{r weighted_wasserstein, fig.cap="Weighted Wasserstein loss function of the FARIMA(0,d,0) process on Figure 1 (bottom).", out.width='60%'}
set.seed(3459)
### Simulate time series
n = 3001
H = 0.8
...
p6 = ggplot(data = NULL, aes(x = par, y = WD)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 11, face = "italic", hjust = 0.5)) +
  ...
  geom_vline(aes(xintercept = par[which.min(WH)], colour = paste("Whittle: ", round(par[which.min(WH)], digits = 3))), show.legend = T) + 
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6"))
...
combined <- p6 + p7 & theme(legend.title = element_blank(), legend.position = 'bottom', legend.text = element_text(size = 11)) 
...
```{r wass_ar1_weighted, fig.cap="Wasserstein loss function and weighted Wasserstein loss function of a Gaussian AR(1) process. The sample size is 3001 and the true parameter is 0.6.", out.width='55%'}
set.seed(8677)
### Simulate time series
n = 3001
theta0 = 0.6
...
a = a1 & theme(legend.title = element_blank(), legend.position = 'right', legend.text = element_text(size = 12)) 
b = a2 & theme(legend.title = element_blank(), legend.position = 'right', legend.text = element_text(size = 12)) 
...
```{r sinkhorn, fig.cap = "Top: Wasserstein loss function of a FARIMA(0,d,0) process. Bottom: Sinkhorn loss function of the same process. The sample size is 1801.", out.width='65%', cache = TRUE}
set.seed(87597684)
### Simulate time series
n = 1801
H = 0.8
...
p9 = ggplot(data = NULL, aes(x = par, y = WD)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 10, face = "italic", hjust = 0.5), legend.title = element_blank(),axis.text.y = element_blank()) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Zoom on the minimum")) +
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
  geom_vline(aes(xintercept = par[which.min(WD)], colour = paste("MWE: ", round(par[which.min(WD)], digits = 3))), show.legend = T) +
...
p10 = ggplot(data = NULL, aes(x = par, y = SH_bary_farima)) + geom_line(alpha = 0.6) + theme_classic() +
  theme(plot.title = element_text(color = "black", size = 10, face = "italic", hjust = 0.5), legend.title = element_blank()) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Sinkhorn Loss, FARIMA(0,d,0)")) +
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
...
p11 = ggplot(data = NULL, aes(x = par, y = SH_bary_farima)) + geom_line(alpha = 0.6) + theme_classic() +
  ...
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Zoom on the minimum")) +
  geom_vline(aes(xintercept = H, colour = paste("True parameter: ", H)), show.legend = T) + 
  geom_vline(aes(xintercept = par[which.min(SH_bary_farima)], colour = paste("MSKE: ", round(par[which.min(SH_bary_farima)], digits = 3))), show.legend = T) +
  geom_vline(aes(xintercept = par[which.min(WH)], colour = paste("Whittle: ", round(par[which.min(WH)], digits = 3))), show.legend = T) +
  scale_colour_manual(values = c("#03045E", "#FF0A54", "#0077B6")) +
  coord_cartesian(xlim=c(H-0.05,H+0.05), ylim=c((min(SH_bary_farima)-0.00001), (min(SH_bary_farima)+0.001)))

a = ggarrange(p8, p9, nrow = 1, ncol = 2, common.legend = TRUE, legend = 'right')
b = ggarrange(p10, p11, nrow = 1, ncol = 2, common.legend = TRUE, legend = 'right')
ggarrange(a,b ,nrow = 2)
...
knitr::include_graphics("/Users/manonfelix/OneDrive/Master thesis/Redaction/images/box_400_farima_gauss.png")
```
...
### Compute all the estimators for the simulated process
set.seed(1405)
for (i in 1:mt){
  n = 3201
  H = 0.8
...
ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  scale_fill_brewer(palette = "RdPu") + 
   theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5), legend.text = element_text(size = 12), axis.text = element_text(size = 10)) +
  labs(title = paste("Gaussian FARIMA(0,d,0) processes")) 

```

### Figure 12 

```{r density_long_gauss, out.width='60%', fig.cap="Distribution of the Whittle's estimator and the weighted Wasserstein estimator estimated with the 400 simulations of Figure 11."}
plot.density = rbind(a,c)

p = gghistogram(
  plot.density, x = "value", y = "..density..",
  add = "mean", rug = TRUE,
  fill = "group", palette = c("#DD3C51", "#313657"), add_density = TRUE, xlab = "Parameter values", ylab = "Density"
  )

p + rremove("legend.title") 
```
...
for (i in c(2,4,6,8,10,12,14)){
  ...
  print(paste(mse[1,i-1], ": MSE = ", round(MSE, digits = 6)))
  print(paste(mse[1,i-1], ": BIAS = ", round(BIAS, digits = 6)))
  print(paste(mse[1,i-1], ": VAR = ", round(VAR, digits = 6)))
}
```
...
```{r box_farima_student, fig.cap = "Boxplots of all the estimators presented during this thesis. The sample size of the 200 simulated FARIMA(0,d,0) is 3201 and the underlying distribution is a Student t with degree of freedom equal to 4."}
knitr::include_graphics("/Users/manonfelix/OneDrive/Master thesis/Redaction/images/box_student_400_farima.png")
```
...
WH_s = numeric(mt)
WD_s = numeric(mt)
Weighted_WD_s = numeric(mt)
WD_cdf_s = numeric(mt)
WD_mean_s = numeric(mt)
SH_01_s = numeric(mt)
SH_03_s = numeric(mt)

### Compute all the estimator for all the simulated processes

for (i in 1:mt){
  n = 3201
  H = 0.8
  t = rexp(1600, rate = 1)
  y = fracdiff::fracdiff.sim(n, d = H - 1/2, rand.gen = rt , df = 4)
  y = y$series
  ...
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, mean = TRUE, k = 50)
  WD_mean_s[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, cdf = TRUE)
  WD_cdf_s[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = TRUE)
  Weighted_WD_s[i] = res$minimum

  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.1)
  SH_01_s[i] = res$minimum
   
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.3)
  SH_03_s[i] = res$minimum
}
...
```{r, eval = FALSE}
a = data.frame(group = "Whittle", value = WH_s)
b = data.frame(group = "Wasserstein", value = WD_s)
c = data.frame(group = "Weighted Wass.", value = Weighted_WD_s)
d = data.frame(group = "Semi. Wass.", value = WD_cdf_s)
e = data.frame(group = "Wass. k = 50", value = WD_mean_s)
f = data.frame(group = "Sinkhorn 0.1", value = SH_01_s)
g = data.frame(group = "Sinkhorn 0.3", value = SH_03_s)
...
ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  ylim(0.68, 0.93) +
  theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5), legend.text = element_text(size = 12), axis.text = element_text(size = 10)) +
  labs(title = paste("Student t FARIMA(0,d,0) processes")) 
...
for (i in c(2,4,6,8,10,12,14)){
  ...
  print(paste(mse[1,i-1], ": MSE = ", format(round(MSE, digits = 6), scientific = F)))
  print(paste(mse[1,i-1], ": BIAS = ", format(round(BIAS, digits = 6), scientific = F)))
  print(paste(mse[1,i-1], ": VAR = ", format(round(VAR, digits = 6), scientific = F)))
}
```
...
WH_skew = numeric(mt)
WD_skew = numeric(mt)
Weighted_WD_skew = numeric(mt)
WD_cdf_skew = numeric(mt)
WD_mean_skew = numeric(mt)
SH_01_skew = numeric(mt)
SH_03_skew = numeric(mt)
...
for (i in 1:mt){
  ...
  res = optimize(Whittle, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y)
  WH_skew[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t)
  WD_skew[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, mean = TRUE, k = 50)
  WD_mean_skew[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, cdf = TRUE)
  WD_cdf_skew[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = TRUE)
  Weighted_WD_skew[i] = res$minimum

  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.1)
  SH_01_skew[i] = res$minimum
   
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.3)
  SH_03_skew[i] = res$minimum
}
...
```{r, eval = FALSE}
a = data.frame(group = "Whittle", value = WH_skew)
b = data.frame(group = "Wasserstein", value = WD_skew)
c = data.frame(group = "Weighted Wass.", value = Weighted_WD_skew)
d = data.frame(group = "Semi. Wass.", value = WD_cdf_skew)
e = data.frame(group = "Wass. k = 50", value = WD_mean_skew)
f = data.frame(group = "Sinkhorn 0.1", value = SH_01_skew)
g = data.frame(group = "Sinkhorn 0.3", value = SH_03_skew)
...
ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  theme(axis.title.x=element_blank()) +
  theme(axis.title.y=element_blank()) +
  ggtitle("Skew t FARIMA(0,d,0) processes")+
  scale_fill_brewer(palette = "RdPu") +
  ylim(0.85, 0.99)
...
```{r}
library(fGarch)
x= rsnorm(10000, mean = 0, sd = 1, xi = 2)
plot(density(x))
...
### Positive skewed (larger tail in the positive side)

WH_skew_neg = numeric(mt)
WD_skew_neg = numeric(mt)
Weighted_WD_skew_neg = numeric(mt)
WD_cdf_skew_neg = numeric(mt)
WD_mean_skew_neg = numeric(mt)
SH_01_skew_neg = numeric(mt)
SH_03_skew_neg = numeric(mt)

for (i in 1:mt){
  n = 3201
  H = 0.8
  t = rexp(1600, rate = 1)
  y = fracdiff::fracdiff.sim(n, d = H - 1/2, rand.gen = fGarch::rsnorm , mean = 0 , sd = 1, xi = 2)
  y = y$series
  
  res = optimize(Whittle, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y)
  WH_skew_neg[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t)
  WD_skew_neg[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, mean = TRUE, k = 50)
  WD_mean_skew_neg[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, cdf = TRUE)
  WD_cdf_skew_neg[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = TRUE)
  Weighted_WD_skew_neg[i] = res$minimum
  
  # res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.1)
  # SH_01_skew_neg[i] = res$minimum
  # 
  # res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.3)
  # SH_03_skew_neg[i] = res$minimum
}



a = data.frame(group = "Whittle", value = WH_skew_neg)
b = data.frame(group = "Wasserstein", value = WD_skew_neg)
c = data.frame(group = "Weighted Wass.", value = Weighted_WD_skew_neg)
d = data.frame(group = "Semi. Wass.", value = WD_cdf_skew_neg)
e = data.frame(group = "Wass. k = 50", value = WD_mean_skew_neg)
#f = data.frame(group = "Sinkhorn 0.1", value = SH_01_skew_neg)
#g = data.frame(group = "Sinkhorn 0.3", value = SH_03_skew_neg)
...
# plot.data$group = as.factor(plot.data$group)
# plot.data$group = factor(plot.data$group, levels = c("Whittle", "Wasserstein", "Wass. k = 50", "Semi. Wass.", "Weighted Wass."))
# 
# library(ggplot2)
# ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
#   geom_boxplot()+
...
set.seed(1405)
x= rsnorm(10000, mean = 0, sd = 1, xi = 0.5)
plot(density(x))

### Negative skewed (larger tail in the negative side)
...
for (i in 1:mt){
  ...
  H = 0.8
  t = rexp(1600, rate = 1)
  y = fracdiff::fracdiff.sim(n, d = H - 1/2, rand.gen = fGarch::rsnorm , mean = 0 , sd = 1, xi = 0.5)
  y = y$series
...
for (i in 1:mt){
  ...
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0 , phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = FALSE)
  WD_longmemo[i] = res$minimum
  
  res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 0, q = 0, y = y, theoritical = t, weighted = TRUE, sinkhorn = FALSE)
...
for (i in c(2,4,6)){
  ...
  MSE[i] = mean((mse[,i] - H)^2)
  BIAS[i] = mean(mse[,i]) - H
  VAR[i] = mean(mse[,i]^2) - (mean(mse[,i]))^2
    
#   print(paste(mse[1,i-1], ": MSE = ", round(MSE[i], digits = 6)))
#   print(paste(mse[1,i-1], ": BIAS = ", round(BIAS[i], digits = 6)))
#   print(paste(mse[1,i-1], ": VAR = ", round(VAR[i], digits = 6)))
}

print(paste("ratio MSE:", MSE[2] / MSE[6]))
print(paste("ratio BIAS:", BIAS[2] / BIAS[6]))
print(paste("ratio VAR:", VAR[2] / VAR[6]))
...
WH_AR2_G1 = matrix(data = NA, nrow = mt, ncol = 2)
WD_AR2_G1 = matrix(data = NA, nrow = mt, ncol = 2)
Weighted_WD_AR2_G1 = matrix(data = NA, nrow =mt, ncol = 2)
WD_cdf_AR2_G1 = matrix(data = NA, nrow = mt, ncol = 2)
WD_mean_AR2_G1 = matrix(data = NA, nrow = mt, ncol = 2)
SH_01_AR2_G1 = matrix(data = NA, nrow =mt, ncol = 2)
SH_03_AR2_G1 = matrix(data = NA, nrow =mt, ncol = 2)
...
a = data.frame(group = "Whittle", value = WH_AR2_G1[,1])
b = data.frame(group = "MWE", value = WD_AR2_G1[,1])
c = data.frame(group = "MWWE", value = Weighted_WD_AR2_G1[,1])
d = data.frame(group = "MSWE", value = WD_cdf_AR2_G1[,1])
e = data.frame(group = "MMWE k = 50", value = WD_mean_AR2_G1[,1])
...
for (i in c(2,4,6,8,10)){
  MSE = 1/mt * sum((mse[,i] - 0.75)^2)
  print(paste(mse[1,i-1], ": Mean Squared Error = ", round(MSE, digits = 5)))
}

plot.data$group = as.factor(plot.data$group)
plot.data$group = factor(plot.data$group, levels = c("Whittle", "MWE", "MMWE k = 50", "MSWE", "MWWE"))
...
p1 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  theme(axis.title.y=element_blank()) +
  scale_fill_brewer(palette = "RdPu") +
  ylim(0.5, 0.95) + theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Gaussian AR(2) processes, 1st parameter")) 


### First parameter 0.75
a = data.frame(group = "Whittle", value = WH_AR2_G1[,2])
b = data.frame(group = "MWE", value = WD_AR2_G1[,2])
c = data.frame(group = "MWWE", value = Weighted_WD_AR2_G1[,2])
d = data.frame(group = "MSWE", value = WD_cdf_AR2_G1[,2])
e = data.frame(group = "MMWE k = 50", value = WD_mean_AR2_G1[,2])
#f = data.frame(group = "Sinkhorn 0.1", value = SH_01_AR2[,1])
#g = data.frame(group = "Sinkhorn 0.3", value = SH_03_AR2[,1])
...
p2 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Gaussian AR(2) processes, 2nd parameter")) 

a = ggpubr::ggarrange(p1, p2)
a
```
...
WH_AR2_student = matrix(data = NA, nrow = mt, ncol = 2)
WD_AR2_student = matrix(data = NA, nrow = mt, ncol = 2)
Weighted_WD_AR2_student = matrix(data = NA, nrow =mt, ncol = 2)
WD_cdf_AR2_student = matrix(data = NA, nrow = mt, ncol = 2)
WD_mean_AR2_student = matrix(data = NA, nrow = mt, ncol = 2)
SH_01_AR2_student = matrix(data = NA, nrow =mt, ncol = 2)
SH_03_AR2_student = matrix(data = NA, nrow =mt, ncol = 2)

theta0 = c(0.75, -0.25)

for (i in 1:mt){

  y <- arima.sim(n = n, list(ar = theta0), rand.gen = rt, df = 4)  
  t = rexp(1600, rate = 1)
  
  res = optim(par = c(0,0), Whittle, H = 0.5, phi = 0, p = 2, q = 0, y = y)
  WH_AR2_student[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t)
  WD_AR2_student[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, mean = TRUE, k = 50)
  WD_mean_AR2_student[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, cdf = TRUE)
  WD_cdf_AR2_student[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, weighted = TRUE)
  Weighted_WD_AR2_student[i,] = res$par
  
  #  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, sinkhorn = TRUE, lambda = 0.1)
  # SH_01_AR2_student[i,] = res$par
  #  
  # res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, sinkhorn = TRUE, lambda = 0.3)
  # SH_03_AR2_student[i,] = res$par
...
```{r, eval = FALSE}
### First parameter 0.75
a = data.frame(group = "Whittle", value = WH_AR2[,1])
...
for (i in c(2,4,6,8,10)){
  MSE = 1/mt * sum((mse[,i] - 0.75)^2)
  print(paste(mse[1,i-1], ": Mean Squared Error = ", round(MSE, digits = 6)))
}
...
p1 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  ylim(0.5, 0.99) +
    theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Student t AR(2) processes, 1st parameter")) 


### First parameter 0.75
a = data.frame(group = "Whittle", value = WH_AR2[,2])
...
p2 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  ylim(-0.5, 0)+
    theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Student t AR(2) processes, 2nd parameter")) 
...
WH_AR2_skew = matrix(data = NA, nrow = mt, ncol = 2)
WD_AR2_skew = matrix(data = NA, nrow = mt, ncol = 2)
Weighted_WD_AR2_skew = matrix(data = NA, nrow =mt, ncol = 2)
WD_cdf_AR2_skew = matrix(data = NA, nrow = mt, ncol = 2)
WD_mean_AR2_skew = matrix(data = NA, nrow = mt, ncol = 2)
SH_01_AR2_skew = matrix(data = NA, nrow =mt, ncol = 2)
SH_03_AR2_skew = matrix(data = NA, nrow =mt, ncol = 2)
...
for (i in 1:mt){
  ...
  res = optim(par = c(0,0), Whittle, H = 0.5, phi = 0, p = 2, q = 0, y = y)
  WH_AR2_skew[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t)
  WD_AR2_skew[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, mean = TRUE, k = 50)
  WD_mean_AR2_skew[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, cdf = TRUE)
  WD_cdf_AR2_skew[i,] = res$par
  
  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, weighted = TRUE)
  Weighted_WD_AR2_skew[i,] = res$par
  
  #  res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, sinkhorn = TRUE, lambda = 0.1)
  # SH_01_AR2_skew[i,] = res$par
  #  
  # res = optim(par = c(0,0), Wasserstein, H = 0.5, phi = 0, p = 2, q = 0, y = y, theoritical = t, sinkhorn = TRUE, lambda = 0.3)
  # SH_03_AR2_skew[i,] = res$par
...
p1 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  ylim(0.5, 0.99) +
    theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Skew t AR(2) processes, 1st parameter")) 
...
p2 = ggplot(plot.data, aes(x=group, y=Re(value), fill=group)) +  
  ...
  ylim(-0.5, 0)+
    theme(plot.title = element_text(color = "black", size = 12, face = "italic", hjust = 0.5)) +
  labs(y = expression(""), x = expression("Parameter values"),
       title = paste("Skew t AR(2) processes, 2nd parameter")) 
...
Additive outlier in the short-memory setup
...
for (i in 1:mt){
  ...
  c = 10
  Z = rbinom(n, 1, 0)
  X = arima.sim(n = n, list(ar = theta0), rand.gen = rnorm, sd = 1)  
  V = rt(n, 2)
  y = (1-Z)*X + Z*(c*V)


  res = optimize(Whittle, lower = -0.99, upper = 0.99, maximum = FALSE, H = 1/2 , phi = 0, p = 1, q = 0, y = y)
  WH_rob[i] = res$minimum
  
  res = optimize(Wasserstein, lower = -0.99, upper = 0.99, maximum = FALSE, H = 1/2 , phi = 0, p = 1, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = FALSE)
  WD_rob[i] = res$minimum
  
  res = optimize(Wasserstein, lower = -0.99, upper = 0.99, maximum = FALSE, H = 1/2, phi = 0, p = 1, q = 0, y = y, theoritical = t, weighted = TRUE, sinkhorn = FALSE)
  Weighted_WD_rob[i] = res$minimum
  
  # res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 1, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.01)
  # SH_001_longmemo[i] = res$minimum
  # 
  #res = optimize(Wasserstein, lower = -0.99, upper = 0.99, maximum = FALSE, H = 1/2, phi = 0, p = 1, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.1)
  #SH_01_rob[i] = res$minimum
  # 
  # res = optimize(Wasserstein, lower = 0.51, upper = 0.99, maximum = FALSE, theta = 0, phi = 0, p = 1, q = 0, y = y, theoritical = t, weighted = FALSE, sinkhorn = TRUE, lambda = 0.3)
  # SH_03_longmemo[i] = res$minimum
}

a = data.frame(group = "Whittle", value = WH_rob)
b = data.frame(group = "Wasserstein", value = WD_rob)
c = data.frame(group = "Weighted Wasserstein", value = Weighted_WD_rob)
# d = data.frame(group = "Sinkhorn, 0.01", value = SH_01_rob)
# e = data.frame(group = "Sinkhorn, 0.1", value = data$value_4)
# f = data.frame(group = "Sinkhorn, 0.3", value = data$value_5)
theta0 = 0.6
...
for (i in c(2,4,6)){
  ...
  MSE[i] = mean((mse[,i] - theta0)^2)
  BIAS[i] = mean(mse[,i]) - theta0
  VAR[i] = mean(mse[,i]^2) - (mean(mse[,i]))^2
